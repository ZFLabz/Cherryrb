...
class Gelbooru
	...
	def Gelbooru.downloader

		#Menu
		puts 'Cherry NSFW Tools| Gelbooru Downloader'.red
		...
		url = 'https://gelbooru.com/index.php?page=dapi&s=post&q=index&tags=' + tags + '&pid=' + page + '&limit=' + limit + '&json=1'
		...
		for i in (0..json_hash.length()-1)
			...
			destination = '/downloads/Gelbooru/' + id + '.' + extension
