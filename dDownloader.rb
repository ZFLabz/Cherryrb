...
class Danbooru
	...
	def Danbooru.downloader

		#Menu
		puts 'Cherry NSFW Tools| Danbooru Downloader'.red
		...
		url = 'https://danbooru.donmai.us/posts.json' + '?limit=' + limit + 'page=' + page  + '?tags=' + tags + '&json=1'
		...
		for i in (0..json_hash.length()-1)
			...
			destination = '/downloads/Danbooru/' + id + '.' + extension
