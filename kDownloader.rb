...
class Konachan
	...
	def Konachan.downloader

		#Menu
		puts 'Cherry NSFW Tools| Konachan Wallpapers Downloader'.red
		...
		url = 'https://konachan.com/post.json?page=' + page + '&limit=' + limit + '&tags=' + tags + '&json=1'
		...
		for i in (0..json_hash.length()-1)
			...
			destination = '/downloads/Konachan/' + id + '.' + extension
