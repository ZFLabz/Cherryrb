...
class Safebooru
	...
	def Safebooru.downloader

		#Menu
		puts 'Cherry NSFW Tools| Safebooru Downloader'.red
		...
		url = 'https://safebooru.donmai.us/posts.json' + '?limit=' + limit + 'page=' + page  + '?tags=' + tags + '&json=1'
		...
		for i in (0..json_hash.length()-1)
			...
			destination = '/downloads/Safebooru/' + id + '.' + extension
