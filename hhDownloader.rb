...
class Hypnohub
	...
	def Hypnohub.downloader

		#Menu
		puts 'Cherry NSFW Tools| HynoHub Downloader'.red
		...
		url = 'https://hypnohub.net/post/index.json?page=' + page + '&limit=' + limit + '&tags=' + tags
		...
		for i in (0..json_hash.length()-1)
			...
			destination = '/downloads/other/hypnohub/' + id + '.' + extension
